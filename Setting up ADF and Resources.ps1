...
$dir = "E:\Azure Data Factory Lab\adflab-master\adflab-master\Deployment"        #Working directory of where your LabDeploy.ps1 file is located
$resourceGroupName = "Tirthaadflab-test"          #Name of Azure resource group to deploy the lab resrouces to, will create if it does not exist
$location = "East US 2"                     #Geo location of resource group, resources will use this as well
$labNamePrefix = "Tirtha-adflab"                   #prefix to append on to unique names such as SQLServer and Storage account
$sqlUsername = "labadmin"                   #SqlServer admin account
$sqlPassword = "L@bP@ss01"                  #SqlServer admin password
$logicAppEmail = "cse.tirtha@hotmail.com"          #O365 Account to send emails for lab
$subscriptionName = "Visual Studio Enterprise" #Name of subscription to use for deployment
$dataFactoryName = "adflabadf" #Name of the Azure Data Factory
